  ...
  const chars = [
    {
      slug: "aria",
      name: "Aria",
      description: "Загадочная художница с томным взглядом и страстью к ночным прогулкам",
      personality:
    ...
    },
    {
      slug: "yuki",
      name: "Юки",
      description: "Дерзкая аниме-студентка, которая скрывает нежность за острым языком",
      personality:
        "Ты — Юки, аниме-персонаж. Дерзкая, остроумная, с цундере характером. " +
    ...
    },
    {
      slug: "sofia",
      name: "София",
      description: "Уверенная бизнес-леди, которая знает чего хочет — в работе и в жизни",
      personality:
    ...
    },
    {
      slug: "luna",
      name: "Луна",
      description: "Мистическая ведьмочка, которая видит сны наяву и верит в судьбу",
      personality:
